...
const sidebarLinks = [
  { name: 'All Orders', href: '/dashboard/vendor/orders', icon: ShoppingBag },
];
  ...
  return (
    <div className="p-4 md:p-5 xl:p-6">
      <div className="mb-5 xl:mb-6">
        <h1 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">Order Management</h1>
        <p className="text-[13px] md:text-sm text-gray-500 mt-1 font-medium">Track and manage your customer orders.</p>
      </div>
            ...
            {sidebarLinks.map((link) => {
              ...
              return (
                ...
                >
                  {isActive && (
                    <motion.div
                      layoutId="vendor-orders-active-pill"
