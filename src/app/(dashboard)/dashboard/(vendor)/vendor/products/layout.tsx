...
import { Package, PlusCircle, FileUp } from 'lucide-react';

const sidebarLinks = [
  { name: 'Products List', href: '/dashboard/vendor/products', icon: Package },
  { name: 'Add Product', href: '/dashboard/vendor/products/add', icon: PlusCircle },
  { name: 'Bulk Upload', href: '/dashboard/vendor/products/bulk-upload', icon: FileUp },
];
  ...
  return (
    <div className="p-4 md:p-5 xl:p-6">
      <div className="mb-5 xl:mb-6">
        <h1 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">Product Management</h1>
        <p className="text-[13px] md:text-sm text-gray-500 mt-1 font-medium">Manage your products, inventory and listings.</p>
      </div>
