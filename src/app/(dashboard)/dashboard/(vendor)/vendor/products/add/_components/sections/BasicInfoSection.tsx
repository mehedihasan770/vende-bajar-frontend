    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          />
          {errors.category && <p className="text-red-500 text-xs mt-1 font-medium">{(errors.category as any).message}</p>}
        </div>

        {/* Brand */}
        <div>
          <label className="block text-sm font-bold text-gray-700 mb-2">Brand <span className="text-red-500">*</span></label>
          <input
          ...
          />
          {errors.brand && <p className="text-red-500 text-xs mt-1 font-medium">{(errors.brand as any).message}</p>}
        </div>
      </div>
      ...
      <div>
        ...
        />
        {errors.description && <p className="text-red-500 text-xs mt-1 font-medium">{(errors.description as any).message}</p>}
      </div>
    </div>
  );
}
