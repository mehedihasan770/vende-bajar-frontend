...
const sidebarLinks = [
  { name: 'General Profile', href: '/dashboard/user/profile', icon: User },
  { name: 'Security', href: '/dashboard/user/profile/security', icon: Lock },
  { name: 'Deactivate Account', href: '/dashboard/user/profile/deactivate', icon: UserMinus },
];
  ...
  return (
    <div className="p-4 md:p-5 xl:p-6">
      <div className="mb-5 xl:mb-6">
        <h1 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">Profile Settings</h1>
        <p className="text-[13px] md:text-sm text-gray-500 mt-1 font-medium">Manage your personal information and security preferences.</p>
      </div>
