...
const sidebarLinks = [
  { name: 'My Addresses', href: '/dashboard/user/addresses', icon: MapPin },
  { name: 'Add Address', href: '/dashboard/user/addresses/add', icon: PlusCircle },
];
  ...
  return (
    <div className="p-4 md:p-5 xl:p-6">
      <div className="mb-5 xl:mb-6">
        <h1 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">Address Book</h1>
        <p className="text-[13px] md:text-sm text-gray-500 mt-1 font-medium">Manage your shipping and billing addresses.</p>
      </div>
            ...
            {sidebarLinks.map((link) => {
              ...
              return (
                ...
                >
                  {isActive && (
                    <motion.div
                      layoutId="addresses-active-pill"
