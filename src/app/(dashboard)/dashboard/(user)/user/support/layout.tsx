...
const sidebarLinks = [
  { name: 'My Tickets', href: '/dashboard/user/support', icon: Headset },
  { name: 'Open New Ticket', href: '/dashboard/user/support/create', icon: PlusCircle },
];
  ...
  return (
    <div className="p-4 md:p-5 xl:p-6">
      <div className="mb-5 xl:mb-6">
        <h1 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">Support Center</h1>
        <p className="text-[13px] md:text-sm text-gray-500 mt-1 font-medium">Get assistance and track your support requests.</p>
      </div>
