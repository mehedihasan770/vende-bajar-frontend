...
const sidebarLinks = [
  { name: 'My Returns', href: '/dashboard/user/returns', icon: RefreshCcw },
  { name: 'Create Return', href: '/dashboard/user/returns/create', icon: PlusCircle },
];
  ...
  return (
    <div className="p-4 md:p-5 xl:p-6">
      <div className="mb-5 xl:mb-6">
        <h1 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">Returns & Refunds</h1>
        <p className="text-[13px] md:text-sm text-gray-500 mt-1 font-medium">Manage your product returns and check refund status.</p>
      </div>
