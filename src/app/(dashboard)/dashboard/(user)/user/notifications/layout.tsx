...
const sidebarLinks = [
  { name: 'All Notifications', href: '/dashboard/user/notifications', icon: Bell },
  { name: 'Preferences', href: '/dashboard/user/notifications/preferences', icon: Settings },
];
  ...
  return (
    <div className="p-4 md:p-5 xl:p-6">
      <div className="mb-5 xl:mb-6">
        <h1 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">Notifications</h1>
        <p className="text-[13px] md:text-sm text-gray-500 mt-1 font-medium">Manage your alert settings and view recent updates.</p>
      </div>
