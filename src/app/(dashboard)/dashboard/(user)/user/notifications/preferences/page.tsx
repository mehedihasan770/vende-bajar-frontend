    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-5 border-b border-gray-100">
        <div>
          ...
          <h2 className="text-xl md:text-3xl font-black text-gray-900 tracking-tight">Notification Preferences</h2>
          <p className="text-[12px] md:text-[13px] text-gray-500 mt-2 font-medium flex items-center gap-2">
            <span className="w-1 h-1 rounded-full bg-gray-300"></span>
            Path: <code className="bg-gray-50 text-primary border border-gray-100 px-1.5 py-0.5 rounded font-mono text-[11px]">user/notifications/preferences</code>
          </p>
        </div>
      ...
      <div className="bg-linear-to-b from-white to-gray-50/50 border border-gray-100 rounded-[2rem] p-8 md:p-16 flex flex-col items-center justify-center text-center shadow-xs relative overflow-hidden">
        ...
        <h3 className="text-lg md:text-xl font-black text-gray-900 mb-3 tracking-tight">Notification Preferences</h3>
        <p className="text-gray-500 max-w-md text-[13px] md:text-sm leading-relaxed font-medium">
          We are currently engineering the <strong>Notification Preferences</strong> interface.
          Soon you will be able to customize how you receive alerts and updates with a high-performance experience.
        </p>
