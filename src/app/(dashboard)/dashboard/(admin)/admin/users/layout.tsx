...
const sidebarLinks = [
  { name: 'User List', href: '/dashboard/admin/users', icon: Users },
  { name: 'Create User', href: '/dashboard/admin/users/create', icon: UserPlus },
];
  ...
  return (
    <div className="p-4 md:p-5 xl:p-6">
      <div className="mb-5 xl:mb-6">
        <h1 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">User Management</h1>
        <p className="text-[13px] md:text-sm text-gray-500 mt-1 font-medium">Manage system users, roles, and permissions.</p>
      </div>
