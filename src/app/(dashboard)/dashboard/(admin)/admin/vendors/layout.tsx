...
const sidebarLinks = [
  { name: 'Vendor List', href: '/dashboard/admin/vendors', icon: Store },
  { name: 'Create Vendor', href: '/dashboard/admin/vendors/create', icon: UserPlus },
];
  ...
  return (
    <div className="p-4 md:p-5 xl:p-6">
      <div className="mb-5 xl:mb-6">
        <h1 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight">Vendor Management</h1>
        <p className="text-[13px] md:text-sm text-gray-500 mt-1 font-medium">Manage vendors, verify applications, and monitor performance.</p>
      </div>
