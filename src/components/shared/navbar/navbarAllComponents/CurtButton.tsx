...
const CurtButton = () => {
    ...
    return (
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="relative p-2 lg:p-2.5 cursor-pointer text-primary bg-primary/10 border border-primary/20 hover:bg-primary hover:text-white transition-all duration-300 rounded-lg group"
        >
