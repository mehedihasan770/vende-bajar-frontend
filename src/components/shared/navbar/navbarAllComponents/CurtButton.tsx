...
const CurtButton = () => {
    ...
    return (
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="relative p-2 lg:p-2.5 cursor-pointer text-gray-700 hover:text-primary transition-colors duration-300 rounded-lg bg-gray-100 hover:bg-primary/10"
        >
